...
class EventTaskExecutor implements Runnable
{
	...
	@Builder
	public EventTaskExecutor(@NonNull EbMSEventDAO ebMSEventDAO, @NonNull EventHandler eventHandler, @NonNull TimedAction timedAction, int maxEvents, String serverId)
	{
